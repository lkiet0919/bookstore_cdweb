...
```shell
apt install nginx
vi /etc/nginx/conf.d/jenkins.tuankiet.online.conf
```

```shell
server {
    listen 80;
    server_name jenkins.tuankiet.online;
...
https://admin:11756872d5eee42d55668b373644901b6d@jenkins.tuankiet.online/project/lab-server
```
...
pipeline {
    ...
    environment {
        REGISTRY_URL = 'harbor.tuankiet.online'
        REGISTRY_USER = 'admin'
