...
```shell
root@lab-server:~# git config --global user.name "Lê Tuấn Kiệt"
root@lab-server:~# git config --global user.email "lkiet0919@gmail.com"
root@lab-server:~# mkdir /data && cd /data && git clone http://localhost:6769/lkiet0919/shoeshop.git
Cloning into 'shoeshop'...
Username for 'http://localhost:6769': lkiet0919
Password for 'http://lkiet0919@localhost:6769':
